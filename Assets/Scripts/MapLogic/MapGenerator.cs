...
namespace MapLogic
{
    public class MapGenerator
    {
        ...
        public MapGenerator(MapProvider mapProvider, GameFactory gameFactory, MeshFactory meshFactory)
        {
        ...
        private unsafe ChunkMeshGeneration[] InitializeJobs(void*[] addresses)
        {
            ...
            for (var i = 0; i < ChunkGenerators.Length; i++)
            {
                var addressByNeighbour = new NativeHashMap<int, IntPtr>(6, Allocator.TempJob);
